...
#curl "http://127.0.0.1:5000/api/v1/cheapshark/find?title=???"
...
#curl "http://127.0.0.1:5000/api/v1/cheapshark/populargames"
...
#curl "http://127.0.0.1:5000/api/v1/cheapshark/lastgames"
...
def steam():
    ...
    global strResult
    responseID = requests.get(
    "http://127.0.0.1:5000/api/v1/cheapshark/steamid?title="+request.args["title"]
    )
...
#curl "http://127.0.0.1:5000/api/v1/cheapshark/steamid?title=???"
...
#curl "http://127.0.0.1:5000/api/v1/cheapshark/steamidJson?title=???"
...
#curl "http://127.0.0.1:5000/api/v1/cheapshark/gameid?title=???"
...
#curl "http://127.0.0.1:5000/api/v1/epicgames"
